...
(function installFinalAudit21517(){
  ...
  function audit21517(){
    try{
      ...
      if(badge)badge.textContent=ok?'v2.15.17 25キャラ完成・実戦監査OK版':'v2.15.17 25キャラ完成・監査注意版';
      if(window.AI_SHOGI_SIDE_TEST)window.AI_SHOGI_SIDE_TEST.version='2.15.17';
      if(window.AI_SHOGI_FINAL21513)window.AI_SHOGI_FINAL21513.version='2.15.17';
      return ok;
