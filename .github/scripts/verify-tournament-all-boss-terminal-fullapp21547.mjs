...
try{
  ...
  if(restore.introAfter.panelOpen)failures.push('introAfter: round panel reopened');
  for(const k of ['pendingAfter','drawAfter'])if(!restore[k].panelOpen||restore[k].dock?.docked)failures.push(`${k}: panel/dock`);
