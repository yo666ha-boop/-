...
try{
  ...
  console.log('PASS_TOURNAMENT21547D_DIALOGUE '+JSON.stringify({bosses:bankAudit.bosses,contexts:bankAudit.contexts,minVariants:bankAudit.minVariants,totalContextVariants:bankAudit.totalContextVariants,antiRepeatUnique:new Set(anti).size,qfPortrait:true,qfRole:'host-outside-bracket',bossInBracket:false,tournamentChampionDialogue:true,bossPendingDialogue:true,bossMid:true,materialFallbackAdvantage:true,materialFallbackDisadvantage:true,teacherEvalPriority:true,completeClear:true,mobileOverflow:Math.max(0,mobile.doc-mobile.vw)}));
