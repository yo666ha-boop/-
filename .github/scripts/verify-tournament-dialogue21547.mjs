...
try{
  ...
  assert.equal(bankAudit.bosses,8);assert.equal(bankAudit.contexts,16);assert.ok(bankAudit.minVariants>=25);assert.ok(bankAudit.totalContextVariants>=3200);
