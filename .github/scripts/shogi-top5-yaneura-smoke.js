...
(async()=>{
  ...
  const audit=await page.evaluate(()=>{
    ...
    return {indices:api.indices,names:api.names,ratings:api.ratings,sharedWorker:api.sharedWorker,engine:api.engine,chars,coi:crossOriginIsolated};
  });
  ...
  console.log('PASS top5: みつき/みっちゃん/あき王/おにまま/まま -> shared YaneuraOu HalfKP + Suisho5');
