            ...
            skin.addEventListener('load',()=>{
              ...
              bank.addEventListener('load',()=>{
                ...
                dialogue.addEventListener('load',()=>{
                  ...
                  game.src=new URL('./tournament-game-ui21559.js?v=21562',scriptURL).href;
                  game.async=false;
...
body:has(#tournament21540Panel.tourFireFit) .side>#tourDialogue21547.tourDialogueBattleDock21547{grid-template-columns:52px minmax(0,1fr);gap:7px;padding:6px;margin:5px 0}body:has(#tournament21540Panel.tourFireFit) .side>#tourDialogue21547.tourDialogueBattleDock21547 .tourDialoguePortrait{width:48px;height:48px;border-radius:10px}body:has(#tournament21540Panel.tourFireFit) .side>#tourDialogue21547.tourDialogueBattleDock21547 .tourDialogueBubble{font-size:10px;line-height:1.4;padding:5px 6px}
