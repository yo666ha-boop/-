if(typeof window==='undefined'){
  ...
  (()=>{
    if(window.__AI_SHOGI_BOARD_THEME_LOADER_21538A)return;
    window.__AI_SHOGI_BOARD_THEME_LOADER_21538A=true;
    try{
      const scriptURL=document.currentScript?.src||location.href;
      const s=document.createElement('script');
      s.src=new URL('./board-theme21537.js?v=21538a',scriptURL).href;
      s.async=false;
  ...
  (()=>{
    ...
    const RELOAD_KEY='ai-shogi-coi-reload-21538a';
