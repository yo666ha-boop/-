...
.tourBracketWrap{margin:8px 0 10px}.tourBracketCaption{display:flex;justify-content:space-between;gap:8px;align-items:end;font-size:11px;color:#cfc39e;margin-bottom:5px}.tourBracketSwipeHint{display:none}.tourBracketScroll{overflow-x:auto;overscroll-behavior-x:contain;-webkit-overflow-scrolling:touch;padding-bottom:5px}.tourBracket{display:flex;gap:6px;min-width:880px;border:1px solid #3f3827;border-radius:11px;background:#07100e;padding:7px}.tourBracketRound{width:164px;flex:0 0 164px;min-width:0}.tourBracketRoundTitle{text-align:center;font-size:11px;font-weight:900;color:#e6ce82;margin-bottom:4px}.tourBracketRoundBody{height:650px;display:flex;flex-direction:column;justify-content:space-around;gap:2px}
...
@media(max-width:520px){#tournament21540Btn{min-height:44px}.tourGrid{grid-template-columns:1fr}.tourActions .btn{flex-basis:100%;min-height:44px;padding:10px 8px}.tourHead .miniBtn{min-height:40px;padding:7px 10px}.tourBracketWideHint{display:none}.tourBracketSwipeHint{display:inline;color:#ffe49a;font-weight:900}.tourBracketScroll{scroll-snap-type:x proximity}.tourBracketRoundBody{height:620px}.tourBracket{min-width:820px}.tourBracketRound{width:152px;flex-basis:152px;scroll-snap-align:start}}
`;document.head.appendChild(s);
  ...
  function renderBracket(a,cup){
    ...
    return'<div class="tourBracketWrap"><div class="tourBracketCaption"><b>16人トーナメント表</b><span class="tourBracketWideHint">他の山も同じ回戦を進行中</span><span class="tourBracketSwipeHint">横にスワイプ →</span></div><div class="tourBracketScroll"><div class="tourBracket">'+cols+'</div></div></div>';
  }
  ...
  function renderActive(store){
    ...
    else action='<button class="btn primary" data-tour-current="1">現在の対局を開く</button><button class="btn" data-tour-exit="1">大会をやめる</button>';
  ...
  function startCup(id,retry=false){
    ...
    const bracket=buildBracket(cup,seed),playerSlot=bracket.rounds[0].indexOf(PLAYER);
