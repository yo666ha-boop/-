...
@media(max-width:520px){#tournament21540Btn{min-height:44px}.tourGrid{grid-template-columns:1fr}.tourActions .btn{flex-basis:100%;min-height:44px;padding:10px 8px}.tourHead .miniBtn{min-height:40px;padding:7px 10px}.tourBracketRoundBody{height:620px}.tourBracket{min-width:820px}.tourBracketRound{width:152px;flex-basis:152px}}
